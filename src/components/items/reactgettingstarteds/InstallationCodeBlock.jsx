      ...
      <div className='grid grid-cols-2 gap-4 mb-2'>
        <div className='w-full'>
          <div className="relative mb-2">
            <input id="step1-id" type="text" className="col-span-6 border text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-gray-400 focus:ring-blue-500 focus:border-blue-500" value={props.txtstep} disabled readonly />
            <button onClick={() => navigator.clipboard.writeText(`${props.txtstep}`)} className={`${props.iscopy ? '' : 'hidden'} absolute end-2 top-1 text-gray-400 hover:bg-gray-800 rounded-lg p-2 inline-flex items-center justify-center`}>
              <span>
        ...
        <div className="w-full bg-gray-700 border border-gray-600 shadow rounded-lg py-3 px-5">
          <h2 className="text-md font-semibold text-gray-400 mb-2">Result Terminal</h2>
